...
<template>
    <div class="w-1/6 h-screen    bg-slate-100 text-black">
        <div class="flex  pt-6 pl-2 md:pl-4">
            ...
            <h1 class="text-lg pl-10 p-2 text-orange-500 hidden md:block ">LapStore</h1>
        ...
        <div >
            ...
            <div id="container" class="flex  hover:bg-white rounded-md  hover:text-orange-500 mt-3">
                ...
                <div class="pl-4 flex p-2">
                    ...
                    <div class="ml-8 hidden md:block"  :class="{'text-orange-500':route.name==='app.dashboard'}">
                        DashBoard
                    </div>
        ...
        <router-link :to="{name: 'app.products'}">
            ...
            <div  id="container" class="flex hover:bg-white rounded-md  hover:text-orange-500 mt-3">
                ...
                <div class="pl-4 flex p-2">
                    ...
                    <div class="ml-8 hidden md:block" :class="{'text-orange-500':route.name==='app.products'}">
                        Products
                    </div>
        ...
        <router-link :to="{name: 'app.users'}">
            ...
            <div id="container" class="flex   hover:bg-white rounded-md hover:text-orange-500 mt-3">
                ...
                <div class="pl-4 flex p-2">
                    ...
                    <div class="ml-8 hidden md:block"  :class="{'text-orange-500':route.name==='app.users'}">
                        Users
                    </div>
