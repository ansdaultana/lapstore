    ...
    <div>
        <div class="fixed top-0 left-0 right-0 z-[100] bg-transparent shadow-lg rounded-b-xl flex justify-between p-1 md:p-2  rounded-md    text-white">
          ...
          <div class="text-xl mt-2 ml-1  ">
            ...
            <div class="flex p-1">
                <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" class="w-6 h-6 mt-3 text-orange-500 transition-transform hover:scale-105 ">
                  ...
                  <div class="m-3 -ml-1">
                    <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" class="w-6 h-6 text-orange-500 transition-transform hover:scale-105 hover:cursor-pointer">
