    ...
    <div
      ...
      <div class="flex ">
        ...
        <div class="m-2 ">
          ...
          <div
            class="hidden absolute right-16 h-36 w-32 lg:w-48 bg-white p-2 rounded-md shadow-md"
        ...
        <div class="mt-3 -ml-1">
          <a href="{{route('cart.view')}}">
            <div class="flex">
              ...
              <span class=" text-gradient font-bold -mt-2 animate-pulse">{{count(session('cart',[]))}}</span>
        ...
        <div class="mt-3 ml-1 mr-2">
          <a href="{{route('favourite.view')}}">
            <div class="flex">
              ...
              <span class=" text-gradient font-bold -mt-2 animate-pulse">{{count(session('favourite',[]))}}</span>
            </div>
          </a>
