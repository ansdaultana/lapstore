...
<main
    x-data="{ selectedImage: '{{ $product->images[0]->image_url }}',quantity:1 }">
    <div class="flex">
        <div class="w-1/2 h-full justify-center items-center flex">
            <div class="w-full">
                <div class="items-center justify-center flex ">
                    ...
                    <div
                        class="p-8 w-96    rounded-2xl mt-6 hover:cursor-pointer transition-transform hover:scale-103 ease-in-out duration-300  shadow-sm bg-gradient-to-bl from-orange-100 via-orange-50 to-slate-100 shadow-green-200">
                        <img class="rounded-2xl md:w-96"
                            x-bind:src="selectedImage" alt>
                    </div>
                </div>
                @if($product->images)
        ...
        <div class="w-1/2 h-full ">
            ...
            <div class="mt-2 p-2 md:p-8 flex flex-row">
                <div
                    ...
                    <div
                        x-text="quantity"
                        class="p-1 md:py-2 md:px-4 text-orange-600 text-2xl font-bold animate-"></div>
                    <button
            ...
            <div
                ...
                <div class="flex">
                    <div class="p-3">
                        <svg id="footer" class="animate-bounce"
                    ...
                    <div class="p-2"> <div class="font-body">Fast Delivery</div>
                        <span
                            class="text-xs underline hidden md:block">You
                            will
                            recieve the
                            package in 3 to
                ...
                <div class="flex border-t">
                    <div class="p-3">
                        <svg id="footer" xmlns="http://www.w3.org/2000/svg"
                            height="2em"
                    ...
                    <div class="py-2 px-4 "> <div class="font-body textxs">Return
                            Delivery</div> <span
                            class="text-xs underline hidden md:block">Free
                            30
                            days Return
                            Policy.</span></div>
                </div>
